...
![All MLflow runs side-by-side](screenshots/14_mlflow_compare_runs.png)
...
| Screenshot | Capture |
|---|---|
| `screenshots/11_mlflow_runs_table.png` | All 7 runs in the experiment table |
| `screenshots/14_mlflow_compare_runs.png` | Bar chart comparing 5 metrics across all runs (auto-generated by `scripts/_render_mlflow_compare.py`) |
| `screenshots/15_cm_best_rf_shallow.png` | Confusion matrix of the winning variant |
| `screenshots/16_roc_best_rf_shallow.png` | ROC curve of the winning variant |
| `screenshots/17_cm_gb_default.png` | Confusion matrix of the weakest variant (for contrast) |
...
| 12 | Screenshots folder | ✅ | `reports/screenshots/` (UI, Swagger, MLflow, kubectl, GitHub Actions, EDA, comparison plot) |
