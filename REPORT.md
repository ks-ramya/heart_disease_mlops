...
![All MLflow runs side-by-side](screenshots/05_mlflow_compare_runs.png)
...
| `reports/figures/confusion_matrix.png` / `roc_curve.png` | Best-model CM + ROC artefacts produced by `evaluate.py` and logged to MLflow |
